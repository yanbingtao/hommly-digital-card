...
export const RECIPIENT_CARD_META_SELECT =
  'id, order_id, public_token, theme, animation, status, view_pin_enabled, show_sender_links, created_at, updated_at, published_at, first_published_at, expires_at_override, photo_uploaded_at, order:orders(*)';
